  ...
  clientes: [
    {
      ...
      npsHistorico: [
        { mes: "Set/2025", score: 60, classificacao: "Promotor" },
        { mes: "Out/2025", score: 65, classificacao: "Promotor" },
        { mes: "Nov/2025", score: 70, classificacao: "Promotor", comentario: "Time muito bem selecionado, entrega consistente." },
        { mes: "Dez/2025", score: 72, classificacao: "Promotor" },
        { mes: "Jan/2026", score: 75, classificacao: "Promotor" },
        { mes: "Fev/2026", score: 78, classificacao: "Promotor", comentario: "Qualidade do time superou expectativa inicial." },
        { mes: "Mar/2026", score: 80, classificacao: "Promotor" },
      ],
      npsGestores: [
    ...
    },
    {
      ...
      npsHistorico: [
        { mes: "Out/2025", score: 55, classificacao: "Promotor" },
        { mes: "Nov/2025", score: 60, classificacao: "Promotor" },
        { mes: "Dez/2025", score: 58, classificacao: "Promotor" },
        { mes: "Jan/2026", score: 65, classificacao: "Promotor" },
        { mes: "Fev/2026", score: 68, classificacao: "Promotor", comentario: "PM alocado trouxe grande evolução no roadmap." },
        { mes: "Mar/2026", score: 70, classificacao: "Promotor" },
      ],
      npsGestores: [
    ...
    },
    {
      ...
      npsHistorico: [
        { mes: "Nov/2025", score: 75, classificacao: "Promotor" },
        { mes: "Jan/2026", score: 80, classificacao: "Promotor", comentario: "Posições fechadas exatamente com o perfil solicitado." },
        { mes: "Mar/2026", score: 82, classificacao: "Promotor" },
      ],
      npsGestores: [
